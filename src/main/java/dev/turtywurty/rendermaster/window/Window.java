package dev.turtywurty.rendermaster.window;
...
import dev.turtywurty.rendermaster.exceptions.WindowCreateException;
import dev.turtywurty.rendermaster.image.Image;
import dev.turtywurty.rendermaster.image.ImageUtils;
import dev.turtywurty.rendermaster.math.VectorUtils;
...
public class Window {
    ...
    // TODO: Remove this and allow the glfwWindowShouldClose and glfwSwapBuffers to
